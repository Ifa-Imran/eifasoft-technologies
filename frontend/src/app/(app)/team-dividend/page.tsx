    ...
    <div className="space-y-6">
      ...
      <GlassCard>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-surface-900">Level Breakdown</h3>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-surface-200">
                <th className="text-left py-3 px-3 text-surface-500 font-medium">Level</th>
                <th className="text-center py-3 px-3 text-surface-500 font-medium">Rate</th>
                <th className="text-center py-3 px-3 text-surface-500 font-medium">Directs Needed</th>
                  ...
                  >
                    <td className="py-3 px-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`font-medium ${isActive ? 'text-success-700' : isNextUnlock ? 'text-primary-700' : 'text-surface-500'}`}>
                          Level {level}
                        </span>
                      </div>
                    </td>
