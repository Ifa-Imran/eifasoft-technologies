...
export default function CMSPage() {
      ...
      <div className="space-y-6">
        <GlassCard>
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-surface-700 mb-2">{t('notAvailable')}</h2>
            <p className="text-surface-500">{t('notAvailableDesc')}</p>
          </div>
        </GlassCard>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <GlassCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-surface-500">{t('yourSubscriptions')}</p>
        ...
        <GlassCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-surface-500">{t('remainingSlots')}</p>
        ...
        <GlassCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-surface-500">{t('subscriptionStatus')}</p>
              <p className={`text-lg font-bold ${isSubscriptionEnded ? 'text-red-600' : 'text-success-600'}`}>
                {isSubscriptionEnded ? t('ended') : t('active')}
              </p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard>
          ...
          {isSubscriptionEnded ? (
            <div className="text-center py-8">
              ...
              <p className="text-surface-500">{t('subscriptionEnded')}</p>
            </div>
          ) : (
            <div className="space-y-5">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-primary-50 to-secondary-50 border border-primary-200/50">
                <h3 className="text-sm font-semibold text-surface-700 mb-3">{t('subscriptionDetails')}</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-surface-600">{t('pricePerSub')}</span>
                    <span className="font-semibold text-surface-900">{CMS_PRICE_USDT} USDT</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-surface-600">{t('loyaltyRewardPerSub')}</span>
                    <span className="font-semibold text-primary-600">{REWARD_PER_SUB_KAIRO} KAIRO</span>
                  </div>
                  <div className="border-t border-primary-200 pt-2 mt-2">
                    <div className="flex justify-between">
                      <span className="text-surface-700 font-medium">{t('totalCost')}</span>
                      <span className="font-bold text-surface-900">{totalCost} USDT</span>
                    </div>
                    <div className="flex justify-between mt-1">
                      <span className="text-primary-700 font-medium">{t('youllEarn')}</span>
        ...
        <GlassCard>
          ...
          {hasClaimed ? (
            <div className="text-center py-8">
              ...
              <p className="text-surface-700 font-semibold">{t('alreadyClaimed')}</p>
            </div>
          ) : (
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100/50 border border-primary-200/50">
                  <p className="text-xs text-surface-600 mb-1">{t('loyaltyRewards')}</p>
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-secondary-50 to-secondary-100/50 border border-secondary-200/50">
                  <p className="text-xs text-surface-600 mb-1">{t('leadershipRewards')}</p>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-success-50 to-success-100/50 border border-success-200/50">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-surface-600 mb-1">{t('totalClaimable')}</p>
              ...
              <div className="p-4 rounded-xl bg-surface-50 border border-surface-200">
                <h3 className="text-sm font-semibold text-surface-700 mb-3">{t('claimRules')}</h3>
                <div className="space-y-2 text-xs text-surface-600">
                  <div className="flex items-start gap-2">
                    ...
                    <span>{t('claimRule1')}</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <InformationCircleIcon className="w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5" />
                    <span>{t('claimRule2')}</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <InformationCircleIcon className="w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5" />
                    <span>{t('claimRule3')}</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <InformationCircleIcon className="w-4 h-4 text-primary-500 flex-shrink-0 mt-0.5" />
                    <span>{t('claimRule4')}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="p-3 rounded-xl bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200/50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-red-700 font-medium">
                      {t('excessWarning', { amount: Number(excessFormatted).toFixed(2) })}
                    </span>
                  </div>
                </div>
              )}
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-surface-50 to-surface-100/50 border border-surface-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-surface-600">{t('maxClaimable')}</span>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-surface-200">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-surface-600">{t('levelCol')}</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-surface-600">{t('requiredDirectsCol')}</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-surface-600">{t('rewardPerSubCol')}</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-surface-600">{t('subscriptionsCol')}</th>
                  <th className="text-center py-3 px-4 text-sm font-semibold text-surface-600">{t('earnedCol')}</th>
                </tr>
              </thead>
              <tbody>
                {[0, 1, 2, 3, 4].map((level) => {
                    ...
                    <tr key={level} className="border-b border-surface-100 hover:bg-surface-50/50">
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold text-surface-900">{t('levelLabel', { level: level + 1 })}</span>
                        </div>
                      </td>
      ...
      {/* Info Section */}
      <GlassCard>
        <h2 className="text-xl font-bold text-surface-900 mb-4">{t('howCmsWorks')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-surface-600">
              <li className="flex items-start gap-2">
                <span className="font-semibold text-primary-600 w-20">{t('level1')}</span>
                <span>{t('level1Desc')}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-semibold text-primary-600 w-20">{t('level2')}</span>
                <span>{t('level2Desc')}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-semibold text-primary-600 w-20">{t('level3')}</span>
                <span>{t('level3Desc')}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-semibold text-primary-600 w-20">{t('level4')}</span>
                <span>{t('level4Desc')}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="font-semibold text-primary-600 w-20">{t('level5')}</span>
                <span>{t('level5Desc')}</span>
              </li>
            </ul>
          </div>
        </div>
